...
def partie_graphique():
    ...
    relancer_des = Button(fenetre,text="Lancer dés",command=Combinaison.relancer_des(Combinaison,Combinaison.index_a_relancer)).grid(row=4,column=6)
    terminer_tour = Button(fenetre,text="Terminer").grid(row=4,column=7)
    sauvegarde = Button(fenetre,text="Sauvegarde",command=Partie.sauvegarde).grid(row=9,column=3)
    #textvariable=Combinaison.des[0]
    de_1= Button(fenetre,text="0",command=Combinaison.ajouter_des_a_index(Combinaison,1,Combinaison.index_a_relancer)).grid(row=2,column=1)
    de_2 = Button(fenetre,text="1",command=Combinaison.ajouter_des_a_index(Combinaison,2,Combinaison.index_a_relancer)).grid(row=2,column=2)
    de_3 = Button(fenetre,text="2",command=Combinaison.ajouter_des_a_index(Combinaison,3,Combinaison.index_a_relancer)).grid(row=2, column=3)
    de_4 = Button(fenetre, text="3",command=Combinaison.ajouter_des_a_index(Combinaison,4,Combinaison.index_a_relancer)).grid(row=2, column=4)
    de_5 = Button(fenetre, text="4",command=Combinaison.ajouter_des_a_index(Combinaison,5,Combinaison.index_a_relancer)).grid(row=2, column=5)
    reset = Button(fenetre,text="Nouvelle Partie").grid(row=4,column=8)
    #fenetre.mainloop()
def charger_partie():
        try:
            Partie.restaure()
